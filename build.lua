...
typesetdemofiles = {"bnuthesis-example.tex", "spine.tex"}
...
tdslocations = {
  "bibtex/bst/bnuthesis/*.bst",
  "tex/latex/bnuthesis/tsinghua-name-bachelor.pdf",
}
...
function update_tag(file, content, tagname, tagdate)
  local url = "https://github.com/Quejiahao/bnuthesis"
